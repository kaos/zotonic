				...
				{% endif %}
					<div class="product-price clearfix">
						...
						<div class="clearfix button-wrapper right">
							...
							{% else %}
								...
								{% button id="product-buy-basket" class="buy-me" text="koop direct &raquo;" action={shop_buynow id=rsc_id} %}
							{% endif %}
						</div>
					</div>
					...
					{% if p.is_variant %}
						...
						<li class="clearfix product-price">
							...
							<p>
								&euro;{{ v.price_actual|format_price }}
								{% if v.price_old %}(was {{v.price_old|format_price}}){% endif %}

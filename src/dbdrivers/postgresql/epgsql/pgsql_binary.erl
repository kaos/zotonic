...
encode(int2, N) when is_binary(N) -> encode(int2, zp_convert:to_integer(N));
encode(int4, N) when is_binary(N) -> encode(int4, zp_convert:to_integer(N));
encode(int8, N) when is_binary(N) -> encode(int8, zp_convert:to_integer(N));

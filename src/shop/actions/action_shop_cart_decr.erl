...
render_action(TriggerId, TargetId, Args, Context) -> 
	...
	{PostbackMsgJS, _PickledPostback} = zp_render:make_postback({shop_cart_decr, Id, Variant}, postback, TriggerId, TargetId, ?MODULE, Context),
	{PostbackMsgJS, Context}.

event({postback, {shop_cart_decr, Id, Variant}, _TriggerId, _TargetId}, Context) ->
    N = shop_cart:decr_product(Id, Variant, Context),
    ContextDecr = zp_render:update(

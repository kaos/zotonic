...
-module(action_shop_shop_cart_incr).
-author("Marc Worrell <marc@worrell.nl").
...
render_action(TriggerId, TargetId, Args, Context) -> 
	...
	{PostbackMsgJS, _PickledPostback} = z_render:make_postback({shop_cart_incr, Id, Variant}, postback, TriggerId, TargetId, ?MODULE, Context),
	{PostbackMsgJS, Context}.

event({postback, {shop_cart_incr, Id, Variant}, _TriggerId, _TargetId}, Context) ->
    N = shop_cart:add_product(Id, Variant, Context),
    ContextIncr = z_render:update(

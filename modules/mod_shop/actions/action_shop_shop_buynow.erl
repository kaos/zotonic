...
-module(action_shop_shop_buynow).
-author("Marc Worrell <marc@worrell.nl").
...
render_action(TriggerId, TargetId, Args, Context) -> 
	...
	{PostbackMsgJS, _PickledPostback} = z_render:make_postback({shop_buynow, Id, Variant}, postback, TriggerId, TargetId, ?MODULE, Context),
	{PostbackMsgJS, Context}.

event({postback, {shop_buynow, Id, Variant}, _TriggerId, _TargetId}, Context) ->
    shop_cart:add_product(Id, Variant, Context),
    Url = z_dispatcher:url_for(shop_cart, Context),

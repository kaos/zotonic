...
<div class="item-wrapper" id="sort-user-credentials">
	...
	<div class="item clearfix admin-form">
		<p>Add/remove credentials. <a href="javascript:void(0)" class="do_dialog {title: 'Help about user credentials.', text: 'When you add credentials to a person then the person becomes an user. A person or machine can log on with those credentials and perform actions on your Zophrenic system.<br/><br/>What an user can do depends on the groups the user is member of.', width: '450px'}">Need more help?</a></p>
		<p>
